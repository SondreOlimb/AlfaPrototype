# Generated by Django 3.1.2 on 2020-12-23 09:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_shoe', models.CharField(default=0, max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('pintrest_url', models.CharField(blank=True, max_length=255, null=True)),
                ('shoes', models.ManyToManyField(to='blog.Shoe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_image_url', models.CharField(default='0', max_length=255)),
                ('body', ckeditor.fields.RichTextField(blank=True, null=True)),
                ('snippet', models.CharField(max_length=255)),
                ('post_date', models.DateTimeField(auto_now_add=True)),
                ('category', models.CharField(default='uncategorized', max_length=255)),
                ('shoes', models.CharField(default='0', max_length=255)),
                ...
                ('polyline', models.CharField(default=0, max_length=100000)),
